    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx in range(num_batch):
            ...
            with T.no_grad():
                ...
                a_tar_star = T.argmax(Q_dist_target, dim=1)
                Q_dist_tar_star = Q_dist_target[range_batch, a_tar_star]
            targetQ1 = reward_s + (gamma * Q_dist_tar_star.squeeze().detach() * end_multiplier)
        ...
        if epoch % 2 == 0 and epoch != 0:
            with T.no_grad():
                ...
                # average_specificities = np.mean(specificities)
                # print("Specificities(macro):", average_specificities)
