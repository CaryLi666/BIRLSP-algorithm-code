...
if __name__ == '__main__':
    ...
    model_Q = NN(statesize - 1)
    model_tarQ = NN(statesize - 1)
    ...
    for epoch in range(num_epoch):
        ...
        for batch_idx in range(num_batch):  # MAX_Iteration
            ...
            next_action = input_Xtrain_user_next[:, -1]
            next_actions = next_action.to(T.long)

            Q_dist_star = Q_dist_target[range_batch, next_actions]
